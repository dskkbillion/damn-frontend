...
/// 获取卖家主要指标统计数据用例
@injectable
class GetSellerIndexStatisticsUseCase implements UseCase<SellerIndexStatistics, NoParams> {
  final ISellerStatisticsRepository repository;
  
  /// 构造函数，注入仓库
  GetSellerIndexStatisticsUseCase(this.repository);
  
  @override
  Future<Either<Failure, SellerIndexStatistics>> call(NoParams params) {
    return repository.getIndexStatistics();
  }
} 