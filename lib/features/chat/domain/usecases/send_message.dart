...
class SendMessageImpl implements SendMessage {
  ...
  Future<Either<Failure, ChatMessage>> call(SendMessageParams params) async {
    ...
    AppLogger.d('[SendMessage] Type: ${messageToSend.type}, File provided: ${params.file != null}, content omitted');
    ...
    if ((messageToSend.type == ChatMessageType.image || messageToSend.type == ChatMessageType.audio) && params.file != null) {
      AppLogger.d('[SendMessage] Uploading file for ${messageToSend.type} message; path omitted');
      ...
      AppLogger.d('[SendMessage] File uploaded successfully; URL omitted');
      if (fileUrl.isEmpty) {
      ...
      AppLogger.d('[SendMessage] File type message without file; content omitted');
    ...
    AppLogger.d('[SendMessage] Sending message; content omitted');
