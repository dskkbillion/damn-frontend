...
class _SellerOrderListPageState extends State<SellerOrderListPage> with SingleTickerProviderStateMixin {
  ...
  // Tab labels are resolved at build time via _getTabLabels(context)
  ...
  List<String> _getTabLabels(BuildContext context) {
    ...
    return [
      ...
      l10n.order_seller_tab_awaiting_delivery,
      l10n.order_seller_tab_awaiting_confirmation,
      l10n.order_seller_tab_awaiting_evaluation,
      l10n.order_seller_tab_completed,
      l10n.order_seller_tab_after_sale,
      l10n.order_seller_tab_canceled,
    ];
  }
  ...
  List<Widget> _buildTabsWithCounts() {
    ...
    return List.generate(_tabCount, (index) {
