...
class _OrderListPageState extends State<OrderListPage>
  ...
  int _findIndexForStatus(String? statusString) {
    ...
    try {
      ...
      final statusEnum = OrderStatus.values.firstWhere(
          ...
          orElse: () => OrderStatus
              .unknown // Or some default/fallback if string doesn't match
          );
  ...
  void initState() {
    ...
    print(
        '[OrderListPage initState] Received initialStatus: ${widget.initialStatus}, setting initialIndex: $initialIndex');
  ...
  void _onTabChanged() {
    ...
    if (!_tabController.indexIsChanging &&
      ...
      print(
          '[OrderListPage _onTabChanged] Loading orders for tab index: ${_tabController.index}, status: $selectedStatus');
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          AppLocalizations.of(context).order_list_search_hint,
      ...
      body: BlocConsumer<OrderListBloc, OrderListState>(
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                  content: Text(AppLocalizations.of(context)
                      .order_list_load_error(state.message))),
            );
          }
        },
        builder: (context, state) {
          ...
          if (state is OrderListLoaded) {
                    ...
                    onTap: () async {
                      ...
                      if (isAfterSalesOrder) {
                        ...
                        final shouldRefresh = await context
                            .push<bool>('/orderDetail/${order.id}');
            ...
            return SkeletonPage(
                itemCount: 4, itemBuilder: (_, __) => const SkeletonCard());
          } else if (state is OrderListError) {
            // Correct error state name
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(AppLocalizations.of(context)
                          .order_list_load_failed(state.message)),
                      const SizedBox(height: 16),
                      ElevatedButton(
                        // Use the renamed function for retry
                        onPressed: () => _loadOrdersForStatus(
                            _tabStatuses[_tabController.index]),
                        child:
                            Text(AppLocalizations.of(context).order_list_retry),
                      )
                    ],
                  ),
                ),
          ...
          return Center(
              child: Text(AppLocalizations.of(context)
                  .order_list_select_category)); // Initial or empty state
        },
      ),
    );
  }
  ...
  List<Widget> _buildTabsWithBadges() {
    ...
    final tabLabels = [
      l10n.order_list_tab_all,
      l10n.order_list_tab_awaiting_payment,
      l10n.order_list_tab_awaiting_submission,
      l10n.order_list_tab_awaiting_start,
      l10n.order_list_tab_awaiting_delivery,
      l10n.order_list_tab_awaiting_confirmation,
      l10n.order_list_tab_awaiting_evaluation,
