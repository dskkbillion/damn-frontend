    ...
    switch (_currentRegion) {
      case RegionType.domestic:
        ...
        if (url == null || url.isEmpty) {
          throw Exception(
              'BACKEND_BASE_URL environment variable is not set. Please configure it in your .env file.');
        }
        return url;
      case RegionType.international:
  ...
  static String get modelBaseUrl {
    switch (_currentRegion) {
      case RegionType.domestic:
        ...
        if (url == null || url.isEmpty) {
          throw Exception(
              'MODEL_BASE_URL environment variable is not set. Please configure it in your .env file.');
        }
        return url;
      case RegionType.international:
